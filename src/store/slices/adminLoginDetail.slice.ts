...
const adminLoginDetailSlice = createSlice({
    ...
    reducers: {
        removeStore:(state,action)=>{
            console.log("adminLoginDetailSlice removeStore: action.payload", action.payload);

            state.data=action.payload
        },
        createStore:(state,action)=>{
            
            console.log("adminLoginDetailSlice createStore: action.payload", action.payload);
